                    ...
                    <table id="tbl-main" class="table rounded-lg">
                        <thead class="border-bottom bg-warning text-white">
                            <tr>
                                ...
                                <th class="ps-1">{{__('tax.table.name')}}</th>
                                <th class="ps-1">{{__("tax.table.amount")}}</th>
                                <th class="ps-1">{{__("tax.table.option")}}</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="card-body">
                <form name="search-form">
                    <span class="input-group input-group-dynamic mt-3">
                        <label class="form-label">{{ __('tax.filter.fields.name') }} </label>
                        <input type="text" class="form-control" name="s_tax_name" value="{{ old('s_tax_name') }}" />
                    </span>
...
<script src="{{ asset('js/pages/tax.min.js') }}"></script>
@endsection
