                    ...
                    <table id="tbl-main" class="table rounded-lg">
                        <thead class="border-bottom bg-warning text-white">
                            <tr>
                                ...
                                <th class="ps-1">{{__('sales.table.code')}}</th>
                                <th class="ps-1">{{__('sales.table.name')}}</th>
                                <th class="ps-1">{{__("sales.table.email")}}</th>
                                <th class="ps-1">{{__("sales.table.option")}}</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="card-body">
                <form name="search-form">
                    <span class="input-group input-group-dynamic">
                        <label class="form-label">{{ __('sales.filter.fields.code') }} </label>
                        <input type="text" class="form-control" name="s_sales_code" value="{{ old('s_sales_code') }}" />
                    </span>
                    <span class="input-group input-group-dynamic mt-3">
                        <label class="form-label">{{ __('sales.filter.fields.name') }} </label>
                        <input type="text" class="form-control" name="s_sales_name" value="{{ old('s_sales_name') }}" />
                    </span>
                    <span class="input-group input-group-dynamic mt-3">
                        <label class="form-label">{{ __('sales.filter.fields.email') }} </label>
                        <input type="text" class="form-control" name="s_sales_email" value="{{ old('s_sales_email') }}" />
                    </span>
