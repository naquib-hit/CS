@extends('layouts.app', ['title' => __('Pengguna')])
            ...
            <div class="card-body">
                <form name="search-form">
                    <span class="input-group input-group-dynamic">
                        ...
                        <input type="text" class="form-control" name="s_user_username" value="{{ old('s_user_username') }}" />
                    </span>
                    <span class="input-group input-group-dynamic mt-3">
                        <label class="form-label">{{ __('Nama') }} </label>
                        <input type="text" class="form-control" name="s_user_name" value="{{ old('s_user_name') }}" />
                    </span>
                    <span class="input-group input-group-dynamic mt-3">
                        <label class="form-label">{{ __('Email') }} </label>
                        <input type="text" class="form-control" name="s_user_email" value="{{ old('s_user_email') }}" />
                    </span>
